      ...
      fetch("http://127.0.0.1:8086/api/users/authenticate", requestOptions)
          .then(response => {
            if (response.ok) {
                ...
                window.location.href = "https://srinivasnampalli.github.io/NewStudent/"
              } else {
  ...
  <form action="javascript:login_user()">
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='https://srinivasnampalli.github.io/NewStudent/'" class="button-spacing" >Sign Up</button>
